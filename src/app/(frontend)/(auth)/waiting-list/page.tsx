...
export const metadata: Metadata = {
  ...
  title: "Waiting list",
  description: "Your request for the 2nd Annual Advent UNconfernece is submitted successfully!",
}
...
const Page = () => {
  return (
    <div>
      <AuthCardWrapper
        title='Your request for the 2nd Annual Advent UNconfernece is submitted successfully!'
