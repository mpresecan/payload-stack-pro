...
const data = [
  {
    ...
    content:
      "Share what's on your heart. Write down your topic and provide details to attract interest in your session.",
    image: "/dashboard.png",
  ...
  },
  {
    ...
    content:
      "Propose dates that work for you. Interested participants will choose the best fit, finalizing your session's date and time.",
    image: "/dashboard.png",
