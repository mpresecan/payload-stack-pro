...
import { TopicDataProps } from '@/app/(frontend)/(public)/_components/sections/features'
          ...
          <div className="">
            ...
            >
              {topics[currentIndex]?.quote && (
                <motion.div
                  key={currentIndex}
                  className="aspect-auto h-full w-full flex flex-col justify-center items center"
